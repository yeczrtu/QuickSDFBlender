...
const copy = {
  ja: {
    ...
    startGuide: "操作手順を見る",
    supported: "対応環境",
    requirements: ["Blender 5.1／5.2 LTS", "Windows x64", "単一メッシュ", "単一マテリアルスロット", "0–1 UVマップ"],
    ...
    limitations: ["単一オブジェクト", "単一マテリアルスロット", "単一0–1 UV", "Windows x64", "Blender 5.1／5.2 LTS"],
    issue: "GitHub Issueを作成",
    attribution: "Kipfel 公式商品ページ",
    footer: "Quick SDF Paint v0.7.2 — Blender 5.1／5.2 LTS・Windows x64",
    imageAlts: {
  ...
  en: {
    ...
    requirements: ["Blender 5.1 / 5.2 LTS", "Windows x64", "One mesh", "One material slot", "One 0–1 UV map"],
    ...
    limitations: ["One object", "One material slot", "One 0–1 UV map", "Windows x64", "Blender 5.1 / 5.2 LTS"],
