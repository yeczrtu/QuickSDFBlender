...
const copy = {
  ja: {
    ...
    terminologyLinks: [
      { label: "SDF Face Shadow／Shadow SDF mode", sources: [["lilToon", "https://github.com/lilxyzw/lilToon/blob/master/Assets/lilToon/CHANGELOG.md"]] },
      { label: "Face SDF／FaceSDF textures／Face SDF Tex", sources: [["PotaToon", "https://potatoon.dev/en/features/material-settings"]] },
      { label: "SDF_FaceShadow／sdf shadow mask", sources: [["URP Toon", "https://github.com/ChiliMilk/URP_Toon"]] },
      { label: "SDF-based face shadow map", sources: [["Anime Shading Plus", "https://erichu33.github.io/ASPDocs/en/articles/face-shadow-map-creation-and-baking-workflow.html"]] },
      { label: "Shadow Threshold Map／Face Threshold Map／Face Shadow Map", sources: [["akasaki", "https://github.com/akasaki1211/sdf_shadow_threshold_map"], ["Hi-Fi RUSH", "https://media.gdcvault.com/gdc2024/Slides/GDC%2Bslide%2Bpresentations/Tanaka_Kosuke_3D_Toon_Rendering.pdf"], ["Naga", "https://github.com/nagakagachi/NagaSdfTextureToolForUE"]] },
    ],
    startGuide: "操作手順を見る",
    supported: "対応環境",
