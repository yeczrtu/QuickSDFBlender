# Quick SDF Studio 0.6.0 クイックガイド
...
1. [GitHub Releases](https://github.com/yeczrtu/QuickSDFBlender/releases/latest)から `quick_sdf_blender-0.6.0-windows-x64.zip` を取得します。
...
0.6.0はschema 6だけを扱います。以前のProjectを変換する処理はありません。対象Meshから0.6.0用の新しいProjectを作成してください。Texture Paint用DisplayはRGBA8 Image、Baseと手描き範囲はCRC付き1-bit bitplaneとして`.blend`内へ保存されます。Native core ABIは6です。
