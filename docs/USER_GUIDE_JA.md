# Quick SDF Studio 0.3.3 クイックガイド
...
1. [GitHub Releases](https://github.com/yeczrtu/QuickSDFBlender/releases/latest)から `quick_sdf_blender-0.3.3-windows-x64.zip` を取得します。
