# Quick SDF Studio 0.6.1 クイックガイド
...
1. [GitHub Releases](https://github.com/yeczrtu/QuickSDFBlender/releases/latest)から `quick_sdf_blender-0.6.1-windows-x64.zip` を取得します。
...
0.6.xはschema 6だけを扱います。schema 5以前のProjectを変換する処理はありません。0.6.0のProjectは0.6.1でもそのまま開けます。Texture Paint用DisplayはRGBA8 Image、Baseと手描き範囲はCRC付き1-bit bitplaneとして`.blend`内へ保存されます。Native core ABIは6です。
